...
using S = DemoModel.Api.Models.Global.Services;
using G = DemoModel.Api.Models.Global;
using System.Linq;
using DemoModel.Api.Models.Client.Mappers;

namespace DemoModel.Api.Models.Client.Services
{
    public class ContactRepository : IContactRepository<Contact>
    {
        IContactRepository<G.Contact> _globalService;
